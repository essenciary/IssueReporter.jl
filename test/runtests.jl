...
@testset "Adding GitHub issues" begin
  ...
  #   @test isa(IssueReporter.github_auth(), GitHub.OAuth2)
  # end
  ...
  #   @test isa(IssueReporter.report("Trie", "I found a bug", "Here is how you can reproduce the problem: ..."), GitHub.Issue)
  # end
end